...
_s1(ContactForm, "fI828rO/leuY6afu3I0p4IFHNYw=", false, function() {
    return [
...
(()=>{
    const e = new Error("Cannot find module '@/data/content.tsx'");
...
function PortfolioGrid() {
    ...
    const filteredPortfolio = activeCategory === 'Todos' ? portfolio : portfolio.filter((p)=>p.category === activeCategory);
...
//# sourceMappingURL=src_1d6e87ef._.js.map